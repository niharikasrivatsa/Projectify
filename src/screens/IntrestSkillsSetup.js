        ...
        <View style={{backgroundColor: '#FFF'}}>
          <View style={{
            ...
            <Text
              ...
              Choose at least 3 categories in each for more relevant projects. You can always change this under your profile.
            </Text>
          ...
          <View style ={{alignItems: 'center', marginTop: 30}}>
            <OnboardingButton label={'Complete'} onPress={()=>navigation.navigate('')} />
            <Text 
            style ={{
                color:'#FA8C47', 
                fontFamily: 'Nunito_400Regular',
